...
class WalkerNav extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = [], $id = 0 ) {
		...
		$_mega_menu = get_post_meta( $item->ID, 'shopbuilderwp_mega_menu', true );
		if ( ! empty( $_mega_menu ) ) {
			$classes[] = $_mega_menu;
		}
